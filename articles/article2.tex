...
\firstword{Y}{ou} can put a drop-cap on the first word. \blindtext The following two sections are named as \nameref{sec:list} and \nameref{sec:quote}.\\

\phantomsection 
\section*{সেকশন: List Styles} \setcurrentname{List Styles} \label{sec:list}
...
\phantomsection
\section*{সেকশন: Quote Styles} \setcurrentname{Quote Styles} \label{sec:quote}
...
Example 4. \verb|\chapquote{\qtext{Quote}}|
\chapquote{\qtext{Lorem ipsum dolor sit amet, consectetur adipiscing elit.}}
